...
Каждый раз что-то включать и выключать не придётся, просто жмите Alt или Option по необходимости.
...
No need to toggle anything on and off—just press Alt or Option when needed.
...
<details>
  <summary>Differences from the original</summary>
